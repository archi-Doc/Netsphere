...
public class RelayCircuit
{
    ...
    /*internal bool TryEncrypt(int relayNumber, NetAddress destination, ReadOnlySpan<byte> content, out BytePool.RentedMemory encrypted, out NetEndpoint relayEndpoint)
